# ==============================================================
# $Id: shortcut.tcl,v 1.1 2011/10/04 12:23:20 xbourgui Exp $
#
# Copyright (C) 2001 Orbis Technology Ltd. All rights reserved.
# ==============================================================

namespace eval OB_fbcharts::SHORTCUT {
...
proc shortcut {mkt_sort args} {
	...
	switch -- $mkt_sort {
		...
		HT {
			return [shortcut_HT [lindex $args 0]]
		}
		TG {
			return [shortcut_OU [lindex $args 0]]
		}
		SF {
			return [shortcut_SF [lindex $args 0]]
		}DC {
			return [shortcut_DC [lindex $args 0]]
		}
		MR {
		}
	}
