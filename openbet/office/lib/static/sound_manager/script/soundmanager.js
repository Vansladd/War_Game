...
function SoundManager(baseURL, divNum) {
  ...
  this.divNum = 0;
  if (typeof divNum !== 'undefined' && divNum != null && divNum > 0) {
    this.divNum = divNum;
  }

  this.FlashObject = function(url,baseURL) {
    var me = this;
    this.o = null;
    this.loaded = false;
    ...
    var html = ['<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0"><param name="movie" value="'+url+'"><param name="base" value="'+self.baseURL+'"><param name="quality" value="high"></object>','<embed base="'+self.baseURL+'" src="'+url+'" width="1" height="1" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>'];
    ...
    document.getElementsByTagName('div')[self.divNum].appendChild(this.mC);
  }
  ...
  if (!this.unsupported) {
    this.addMovie(this.defaultName,this.baseURL+'/soundcontroller.swf');
...
function soundManagerInit(baseURL, divNum) {
  soundManager = new SoundManager(baseURL, divNum);
}
