# ==============================================================
# $Id: NBWN.tcl,v 1.1.1.1 2011/10/04 10:54:25 xbourgui Exp $
#
# (C) 2000 Orbis Technology Ltd. All rights reserved.
# ==============================================================

namespace eval ADMIN::TXN::NBWN {

asSetAct ADMIN::TXN::NBWN::GoTxn   [namespace code go_balls_sub]
...
proc go_balls_sub args {
	...
	set payout_id [reqGetArg op_ref_id]
	...
	set rs_info         [inf_exec_stmt $stmt_info $payout_id]
	set sub_id         [db_get_col $rs_info 0 sub_id]
