# ==============================================================
# $Id: pmt_batch_GWTD_IDBT.tcl,v 1.1.1.1 2011/10/04 10:54:25 xbourgui Exp $
#
...
proc _set_up_details_IDBT {} {
	...
	set PMTDET($batch_type,$batch_type,filename)   "[OT_CfgGet GWTD_IDBT_FILENAME {}]_${date}_IstaDebit.txt"
	set PMTDET($batch_type,$batch_type,template)   [OT_CfgGet GWTD_IDBT_TEMPLATE {}]
	#foreach {ccy val} [OT_CfgGet GWTD_IDBT_MAX_PMT_PER_CCY {}] {
