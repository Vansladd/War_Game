# ==============================================================
# $Header: /cvsroot-openbet/training/admin/tcl/pmt/pmt_batch_GWTD_NTLR.tcl,v 1.1.1.1 2011/10/04 10:54:25 xbourgui Exp $
#
...
proc _set_up_details_NTLR {} {
	...
	set PMTDET($batch_type,$batch_type,filename)   "[OT_CfgGet GWTD_NTLR_FILENAME {}]_${date}[OT_CfgGet GWTD_NTLR_MID {}].csv"
	set PMTDET($batch_type,$batch_type,template)   [OT_CfgGet GWTD_NTLR_TEMPLATE {}]
	foreach {ccy val} [OT_CfgGet GWTD_NTLR_MAX_PMT_PER_CCY {}] {
	...
	set PMTDET($batch_type,$batch_type,column_list) [list \
		{mid}                         STATIC  [OT_CfgGet GWTD_NTLR_MID {}] \
		{key}                         STATIC  [OT_CfgGet GWTD_NTLR_KEY {}] \
		{date}                        STATIC  $date \
		{email}                       DB      email \
		{fname}                       DB      fname \
		{surname}                     DB      lname \
