...
#
# $Id: ovs_suspension.sh,v 1.1 2011/10/04 12:40:37 xbourgui Exp $
# $Name:  $
#
# Parameters:
...
LD_LIBRARY_PATH=/opt/informix/10.0/lib:/opt/informix/10.0/lib/esql:/opt/openbet/tcl/lib:/opt/openbet/appserv/lib:/opt/openbet/chartdirector/lib:/opt/openbet/release/openssl-0.9.8b/lib
...
CONFIG=box_specific/ovs_suspension_${1}.cfg
...
tclsh ovs_suspension.$XTN $CONFIG
